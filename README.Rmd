...
You can install and run the app from [Github](https://github.com/teebusch/drugx) with:
...
- allow high level overview as well as invsetigating subgroups and individuals
...
- [ ] allow to filter data by age, race, sex, biomarkers 1 and 2, performance at screening, performance at baseline, individual subjects
